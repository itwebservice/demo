...
public function vendor_csv_save()
{
    ...
    if(empty($handle) === false) {
         ...
         if(isset($unprocessedArray) && !empty($unprocessedArray))
        {
          ...
          header("Expires: 0");
          $output = fopen($save, "w");  
          fputcsv($output, array('city_id' , 'DMC_Name' , 'Mobile' , 'landline' ,'Email', 'Contact Person' , 'Emergency Contact No' , 'Address' , 'state_id' , 'Country' , 'Website' , 'Bank Name' , 'Account Name' , 'Account No' , 'Branch', 'IFSC/swift Code' , 'PAN/TAN No' , 'Tax No'));
